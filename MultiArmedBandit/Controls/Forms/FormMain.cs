...
namespace MultiArmedBandit
{
    partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            _formModeling.ResultChanged += (points) => _formChart.BuildChart(points);
        ...
        private void OpenChildForm(Form childForm, TypeForm typeForm)
        {
            ...
            {
                if ((_activeForm is FormModeling || _activeForm is FormChart) == false)
                    _activeForm?.Close();
        ...
        private void OnFormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            else if (_formModeling.IsSimulationFinished == false)
            {
